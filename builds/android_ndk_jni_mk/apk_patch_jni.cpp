...
JNIEXPORT void
Java_com_github_sisong_ApkPatch_initApkDiff(JNIEnv *env, jobject clazz, jstring log_path,
...
#endif
JNIEXPORT jstring
Java_com_github_sisong_ApkPatch_getLastLog(JNIEnv *env, jobject clazz) {
   return env->NewStringUTF(LocalLog::getLastLog());
}
